...
var PopoverContent = /** @class */ (function () {
    ...
    // Protected Methods
    // -------------------------------------------------------------------------
    PopoverContent.prototype.positionElements = function (hostEl, targetEl, positionStr) {
        var positionStrParts = positionStr.split("-");
        var pos0 = positionStrParts[0];
        var pos1 = positionStrParts[1] || "center";
        var hostElPos = this.appendToBody ? this.offset(hostEl) : this.position(hostEl);
    ...
    __decorate([
        core_1.Input(),
        __metadata("design:type", Boolean)
    ], PopoverContent.prototype, "appendToBody", void 0);
    __decorate([
